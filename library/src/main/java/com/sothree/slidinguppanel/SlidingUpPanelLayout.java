...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default attributes for layouts
     */
    ...
    /**
     * The paint used to dim the main layouts when sliding
     */
     ...
     * not provided, the clicks on the dimmed area are passed through to the main layouts.
     *
     * @param listener
     */
    ...
    /**
     * Set the scrollable child of the sliding layouts. If set, scrolling will be transfered between
     ...
     *                    starting from the top of the layouts.
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount != 2) {
            throw new IllegalStateException("Sliding up panel layouts must have exactly 2 children!");
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // Always layouts the sliding view on the first layouts
     ...
     *
     * @param v      View to layouts for horizontal scrollability
