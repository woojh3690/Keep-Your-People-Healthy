...
public class ViewDragHelper {
     ...
     *                       invoked as part of layouts or drawing.
     ...
     * will return false.
     *
     * @param x X position to layouts in the parent's coordinate system
     * @param y Y position to layouts in the parent's coordinate system
     ...
     *
     * @param view Child view of the parent to hit layouts
     * @param x X position to layouts in the parent's coordinate system
     * @param y Y position to layouts in the parent's coordinate system
